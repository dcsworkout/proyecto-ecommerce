  ...
  <div class="min-h-screen" style="background: #FAF7F2;">
    <nav style="background: #1A1208;">
      <div class="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <NuxtLink :to="`/${shop}`" class="text-xs border px-3 py-1.5 tracking-wider uppercase transition"
          style="border-color: #4A3520; color: #C9A96E; font-family: sans-serif; letter-spacing: 0.12em;">← Catalogo</NuxtLink>
      </div>
    </nav>

    <div style="background: #E8D5B0;" class="text-center py-2">
    ...
    <div class="max-w-5xl mx-auto px-6 py-4">
      <p class="text-xs" style="color: #8B7355; font-family: sans-serif;">
        <NuxtLink :to="`/${shop}`" style="color: #8B5E3C;">Catalogo</NuxtLink>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div style="background: #EDE8DF; min-height: 420px;" class="flex items-center justify-center overflow-hidden">
            <img v-if="product.image_urls?.[0]"
              ...
              style="height: 480px; object-position: top;" @error="handleImgError" />
