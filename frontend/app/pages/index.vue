  ...
  <div class="min-h-screen" style="background: #FAF7F2; color: #1A1208; font-family: 'Georgia', serif;">
          ...
          <NuxtLink v-for="product in products" :key="product.id" :to="`/producto/${product.id}`"
            ...
            <div class="overflow-hidden mb-4" style="background: #EDE8DF;">
              <img v-if="product.image_urls?.[0]"
                ...
                style="height: 380px; object-position: top;"
    ...
    <footer style="background: #1A1208; color: #C9A96E;" class="py-12 mt-16">
      <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <p class="text-xs tracking-widest" style="font-family: sans-serif; color: #8B7355; letter-spacing: 0.15em;">
          Tradicion yucateca · Hecho con amor
        </p>
      </div>
    </footer>
  </div>
